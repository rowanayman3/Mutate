...
namespace testoken.Controllers
{
    public class AuthController : Controller
    {
        ...
        public AuthController(IConfiguration configuration , IUserService userService, DataContext context , IEmailService emailService)
        {
        ...
        public async Task<ActionResult<User>> Register(UserRegisterRequest request)
        {
            ...
            string emailBody = $"Please click the following link to verify your account: <a href='{verificationLink}'>{verificationLink}</a>";
        ...
        public async Task<ActionResult> Login(UserLoginRequest request)
        {
            ...
            if (user == null)
            {
                return BadRequest("what is your user ylaa");
            }
            ...
            {
                return BadRequest("get live bro");
            }
            ...
            return Ok($"welcomeback , {user.Username}!" );
        }
        ...
        public async Task<ActionResult> ResetPassword(ResetPasswordRequest request)
        {
            ...
            user.PasswordResetExpire = DateTime.Now.AddMinutes(0);
        ...
        {
            var refreshToken = Request.Cookies["tkn"];
            if (!user.NewToken.Equals(refreshToken))
            {
                return Unauthorized("what are u doing here!");
            }
            else if (user.TokenEnd < DateTime.Now) {
                return Unauthorized("token end man");
            }
            string token = CreateToken(user);
        ...
        private void SetRefreshToken(NewToken newRefreshToken)
        {
            ...
            Response.Cookies.Append("tkn",newRefreshToken.Token,cookieOptions);
